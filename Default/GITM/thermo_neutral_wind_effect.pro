...
for ifile = ff, lf do begin
  ...
  figfile= figfolder+'plot_new/nw_effect_200km/'+strmid(filename,31,20)+'ind_200km'
  ...
  for iLon = 0, nlons-1 do begin
   ...
   localtime = (utime/3600.0 + lon*12.0/180.0) mod 24.0
    ...
    plotct, 255, ctpos, [-100,100],'vi_up (m/s)', /right
    ...
    plotct, 255, ctpos, [0,3], 'Indicator', /right
