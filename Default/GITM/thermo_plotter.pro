...
for iFile = 0, nFiles-1 do begin
    ...
    for iVar = 0, nVarsToPlot-1 do begin
        ...
        if (not Is2D) then DataToPlotAll(iFile,iVar,*,*,*) = data(iV_,*,*,*) $
        else DataToPlotAll(iFile,iVar,*,*,0) = data(iV_,*,*)
    endfor
...
;                    endelse
            ...
            if (iy eq sizes.nby-1) then no00 = 0
...
;               p1 = pos(0)+(pos(2) - pos(0))*0.45 * (1.0 - sin(45.0*!pi/180.0))
;               p2 = pos(3)-(pos(3) - pos(1))*0.45 * (1.0 - sin(45.0*!pi/180.0))
;               xyouts, p1, p2, cLevel, /norm, $
;                       charsize = 0.9, orient = 45, alignment=0.5
;            endif
