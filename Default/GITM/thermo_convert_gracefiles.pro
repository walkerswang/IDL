...
if (n_elements(dirin) eq 0) then dirin = '/raid3/Data/Grace'
...
filein = dirin+'/'+year+'/ascii/Density_graceA_3deg_'+chopr(year,2)+'_'+julian+'.ascii'

fileout = 'grace'+year+month+day+'.dat'
