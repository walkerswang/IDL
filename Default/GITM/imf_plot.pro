...
if (n_elements(PlotSecondPage) eq 0) then PlotSecondPage = 'n'
PlotSecondPage = ask('plot the second and third pages (y/n)', PlotSecondPage)
...
if (strpos(mklower(PlotSecondPage),'y') gt -1) then begin
