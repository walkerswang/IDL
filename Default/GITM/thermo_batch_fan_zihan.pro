...
figname='/Users/wzihan/Simulations/plot_new/ne_350km_conv.ps'
wildcard = foldername+'3DION_t170907_213000.bin'
...
for iFile = 0, nFiles-1 do begin
  ...
  for ii=0,0 do begin
    ...
    if (IsLinePlot) then begin
      ...
      thermo_plot_new_for_potential,cursor_x,cursor_y,strx,stry,step,nvars,sel,nfiles,$
