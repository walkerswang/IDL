...
filelist = file_search('/Users/wzihan/3DALL*.bin')
file = filelist(0)
...
setdevice, '/Users/wzihan/tec_hemisphere.ps','p',5, 0.9
...
save,tmptime, tecnorthday,tecsouthday, filename='tecday.sav'
...
if (DoWriteFile) then begin
  ...
  outfile='/Users/wzihan/tec_summary_'+ymd+'.txt'
  openw,1,outfile
...
for iFile = 0, nFiles-1 do begin
  ...
  setdevice, '/Users/wzihan/tec_'+tostr(iFile,4)+'.ps', 'p', 5
