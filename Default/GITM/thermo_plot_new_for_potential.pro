pro thermo_plot_new_for_potential,cursor_x,cursor_y,strx,stry,step,nvars,sel,nfiles, $
  ...
  nlevelsecond=floor((maxiSecond-miniSecond)/10000.0)
  
  levelSecond = findgen(nlevelsecond)*10000.0 + miniSecond
  ...
  if ghostcells eq 0 then begin
    ...
    northpolelon=[-85]
        ...
        oplot, [npx[0]],[npy[0]], psym = 4, symsize = 3, thick = 10
        ;oplot, [npx[1]],[npy[1]], psym = 7, symsize = 1, thick = 5
      endif
